...
namespace Lesson6
{
    public class CreateAccountPage : Base
    {
        ...
        {
            SendKeys(_firstName, a.FirstName);
            SendKeys(_lastName, a.LastName);
            SendKeys(_address1, a.Address1);
            SendKeys(_postcode, a.Postcode.ToString());
            SendKeys(_city, a.City);
            ...
            SendKeys(_email, a.Email);
            SendKeys(_phone, a.Phone.ToString());
            SendKeys(_passwordDesired, a.Password);
            SendKeys(_passwordConfirm, a.Password);
