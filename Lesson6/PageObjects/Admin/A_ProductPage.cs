...
#region Locators\Elements Prices
        ...
        public A_ProductPage(IWebDriver driver, WebDriverWait wait)
        {
            _driver = driver;
            _wait = wait;
            Init();
        ...
        internal A_CatalogPage FillNewProductData(Product testProduct)
        {
            ...
            //_purchasePriceValue.SendKeys(p.PurchasePriceValue.ToString(CultureInfo.InvariantCulture));
